...
<head>
    ...
    <meta content="The Complete iBarConnect Platform" name="description" />
    <meta content="Squarem Knight Prince Consultancy" name="author" />
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to iBar</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="username" id="username" placeholder="Enter username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                                            @error('username')
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Velzon. Crafted with <i class="mdi mdi-heart text-danger"></i> by Squarem Knight Prince Consultancy
                            </p>
                        </div>
                    </div>
                </div>
